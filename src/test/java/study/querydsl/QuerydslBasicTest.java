...
public class QuerydslBasicTest {
    ...
    /**
     * 회원의 이름과 팀의 이름이 같은 대상 outer join
    ...
    public void fetchJoinNo() throws Exception {
        ...
        boolean load = emf.getPersistenceUnitUtil().isLoaded(findMember.getTeam()); //해당 엔티티 초기화 여부

        assertThat(load).as("페치 조인 미적용").isFalse();
    }
    ...
    @Test
    public void fromSubQuery() throws Exception {
        QMember memberSub = new QMember("memberSub");
    ...
    //enum에 stringValue 사용
//    @Test
//    public void enumToString() {
//        QMember member = QMember.member;
//        List<String> result = queryFactory
//                .select(member.testEnum.stringValue())
//                .from(member)
//                .fetch();
//
//        for (String string : result) {
